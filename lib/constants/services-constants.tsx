...
export const services = [
  ...
  {
    imgSrc: "/images/service2.webp",
    title: "Development",
    index: 2,
    description:
      "We are a Business 2 Business Software as a Service (B2B SaaS) company. Our belief is that Software is a tool, and People are the real business. From an e-commerce site to a data analytics application we can take your concept and develop a solution for your unique needs. Take a look at the Development page and see what we can do!",
    icon: (
      <svg
        className={svgClassName}
        xmlns="http://www.w3.org/2000/svg"
  ...
  {
    imgSrc: "/images/service3.webp",
    index: 3,
    title: "Staffing Agency",
    description:
      "Find the perfect virtual Office Assistant with our dedicated staffing agency. We will match you with a very capable assistant to suit your needs, we have a team of people trained in sales, social media marketing, and even assistants that know the tax industry and the Tax Slayer software.",
    icon: (
      <svg
        className={svgClassName}
        xmlns="http://www.w3.org/2000/svg"
  ...
  {
    imgSrc: "/images/service4.webp",
    title: "Business Data Analytics",
    index: 4,
    description:
      "We teach you how to use your Business Data (sales, income, assets, liabilities, etc.) to make Business Intelligent decisions based on data analysis and predictive modeling. We teach you how to find and understand the data that you need to make Intelligent Business Decisions. This empowers you to optimize your operations, enhance profitability, and drive sustainable growth.",
    icon: (
      <svg
        className={svgClassName}
        xmlns="http://www.w3.org/2000/svg"
  ...
  {
    imgSrc: "/images/service5.webp",
    title: "Mentorship",
    index: 5,
    description:
      "We teach you through our Mentorship Program, coupled with our Training Academy and Live Seminars on Zoom, how to market your business and hire the right people.  You can attend one of the live seminars, or schedule individual sessions if you have the advanced package (eg. subjects: email, social media (fb, instagram), job-websites, etc).",
    icon: (
      <svg
        className={svgClassName}
        xmlns="http://www.w3.org/2000/svg"
  ...
  {
    imgSrc: "/images/service6.webp",
    title: "Online Academy",
    index: 6,
    description:
      "Attend our Live Training Sessions, or use the On Demand Training videos from the comfort of your home, at your own pace, and on your time. We have Tax Training, Tax Slayer Backoffice Training, IRS Updates, Artificial Intelligence Training, E-Commerce (Stripe), Jotform smart forms, and much more.  All training is updated yearly with the new tax regulations or more frequently as needed.",
    icon: (
      <svg
        className={svgClassName}
        xmlns="http://www.w3.org/2000/svg"
