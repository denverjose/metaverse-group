    ...
    <div className="px-6 lg:px-20 pt-32 text-wrap md:text-justify text-primary rounded-lg shadow-lg">
      ...
      <div>
        ...
        <p>
          ...
          you agree to promptly notify us at [{" "}
          {process.env.NEXT_PUBLIC_BUSINESS_EMAIL} ]. Your participation in the
          Program does not require that you make any purchase from us and your
